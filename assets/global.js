  ...
  loadRecommendations(productId) {
    fetch(`${this.dataset.url}&product_id=${productId}&section_id=${this.dataset.sectionId}`)
      ...
      .then((text) => {
        ...
        // Check for products in either grid__item or product-grid structure
        if (html.querySelector('.grid__item') || html.querySelector('.product-grid li')) {
          this.classList.add('product-recommendations--loaded');
        }
      })
      .catch((e) => {
        console.error('Error loading recommendations:', e);
        // Remove the element on error to hide loading state
        this.remove();
      });
  }
}
